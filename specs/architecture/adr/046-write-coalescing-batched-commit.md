...
**Status**: Proposed — adversary gate-1 complete 2026-05-28 (1C + 3H + 3M + 2L; see `specs/findings/2026-05-28-adv-gate1-adr046-write-coalescing.md`), all resolved in **rev-2** below. Implementer phase 0 unblocked on the rev-2 design.
