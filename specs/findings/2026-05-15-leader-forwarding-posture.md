# Finding: Per-protocol leader-forwarding posture (2026-05-15)

**Status**: Findings doc — see ADR-042 §4 (native proxy), ADR-014 (S3 307), ADR-038 (NFS deferral) for the canonical decisions.
**Date**: 2026-05-15
