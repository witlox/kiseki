...
async fn s3_block_size_is_four_bytes_for_all_primitives() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_1_signed_integer_two_complement_big_endian() {
    let mut w = XdrWriter::new();
    w.write_i32(-1);
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_1_signed_integer_round_trip() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_2_unsigned_integer_big_endian() {
    let mut w = XdrWriter::new();
    w.write_u32(0xDEAD_BEEF);
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_2_unsigned_integer_short_input_rejected() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_4_boolean_encoded_as_zero_or_one() {
    let mut w = XdrWriter::new();
    w.write_bool(false);
    assert_eq!(w.into_bytes(), vec![0, 0, 0, 0]);
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_4_boolean_invalid_value_rejected() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_5_hyper_integer_big_endian() {
    let mut w = XdrWriter::new();
    w.write_u64(0x0123_4567_89AB_CDEF);
    assert_eq!(
        w.into_bytes(),
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_5_hyper_integer_round_trip() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_10_variable_length_opaque_pads_to_4_bytes() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_10_variable_length_opaque_round_trip() {
    for sample in [
        vec![],
        vec![0xAB],
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_10_truncated_payload_rejected() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_10_missing_padding_rejected() {
...
/// **No length prefix.**
#[tokio::test(flavor = "multi_thread")]
async fn s4_9_fixed_length_opaque_no_length_prefix() {
    let mut w = XdrWriter::new();
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_9_fixed_length_opaque_round_trip_when_multiple_of_4() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_11_string_wire_shape_matches_opaque() {
    let mut w = XdrWriter::new();
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_11_string_round_trip() {
    let s = "hello, world";
    let mut w = XdrWriter::new();
    w.write_string(s);
    let bytes = w.into_bytes();
...
#[tokio::test(flavor = "multi_thread")]
async fn rfc_example_s4_10_three_bytes_with_one_pad() {
    let mut w = XdrWriter::new();
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_10_opaque_matches_vendored_fixture() {
...
#[tokio::test(flavor = "multi_thread")]
async fn s4_10_fixture_sha256_pinned() {
