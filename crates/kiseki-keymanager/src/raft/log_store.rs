//! In-memory Raft log storage for the key manager.
//!
...
/// In-memory Raft log store for the key manager.
...
impl RaftLogReader<C> for KeyLogStore {
...
impl RaftLogStorage<C> for KeyLogStore {
    type LogReader = Self;
