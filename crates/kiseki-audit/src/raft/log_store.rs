//! In-memory Raft log storage for the Audit shard.
//!
...
/// In-memory Raft log store for the Audit shard.
...
impl RaftLogReader<C> for AuditLogStore {
...
impl RaftLogStorage<C> for AuditLogStore {
    type LogReader = Self;
