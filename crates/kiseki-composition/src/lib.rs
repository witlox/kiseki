...
pub use composition::{
    ...
    encode_composition_update_payload, encode_namespace_create_payload, Composition,
    CompositionOps, DeleteResult, COMPOSITION_CREATE_PAYLOAD_PREFIX_LEN,
    COMPOSITION_DELETE_PAYLOAD_LEN, COMPOSITION_UPDATE_PAYLOAD_LEN, INLINE_DATA_THRESHOLD,
    NAMESPACE_CREATE_PAYLOAD_LEN,
};
